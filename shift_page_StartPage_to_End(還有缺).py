...
'''
# 缺 class RankingPage1(object):  # 排行榜(前)
'''
...
'''
# 缺 class Day1Page1(object):  # Day 1 小知識的日子
# 缺 class Day4Page1(object):  # Day 1 小知識的日子
# 缺 class CorrectPage(object):  # Day 1 答對頁面
# 缺 class WrongPage(object):  # Day 1 答錯頁面
'''

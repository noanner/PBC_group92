...
class Window(tk.Frame):
    ...
    def createWidgets(self):
        f1 = tkFont.Font(size = 22, family = "微軟正黑體")
        f2 = tkFont.Font(size = 14, family = "微軟正黑體")
        f3 = tkFont.Font(size = 12, family = "微軟正黑體")
        
        # row0 標題、敘述、行事曆按鈕
        self.lbl_topic = tk.Label(self, text = "Day1", height = 2, width = 7, font = f1)
        self.lbl_description = tk.Label(self, text = "以下是目前的剩餘庫存，請問今天要訂多少貨呢?", height = 2, width = 40, font = f3)
        self.btn_schedule = tk.Button(self, text = "行事曆", command = self.clickBtnSchedule, height = 2, width = 6, font = f2, bg = 'Lavender')
        ...
        self.lbl_cost = tk.Label(self, text = "總價:$$$$$", height = 1, width = 7, font = f3, bg = 'OldLace')
        self.btn_order = tk.Button(self, text = "訂購!", command = self.clickBtnOrder, height = 1, width = 5, font = f2, bg = 'Lavender')
        
        #-----------------------------------------------------------------------------------------------
        # row0
        self.lbl_topic.grid(row = 0, column = 0, columnspan = 2, sticky = tk.W)
        self.lbl_description.grid(row = 0, column = 2, columnspan = 4, sticky = tk.W)

...
class FirstdayStockPage(object):  # Day1 訂貨畫面 (教學功能)
...
class EverydayStockPage(object):  # Day2~Day7 訂貨畫面 (是否加個計算功能?)
    ...
    def createPage(self):
        ...
        # row0 標題、敘述、行事曆按鈕
        self.page.lbl_topic = tk.Label(self.page, text = ("請根據目前的剩餘庫存，決定Day" + str(counts + 1) +"要訂多少貨!"), height = 2, width = 7, font = f1,
                                       bg = '#f9f7f1', fg = '#666666')
        self.page.lbl_description = tk.Label(self.page, text = "以下是目前的剩餘庫存，請問今天要訂多少貨呢?", height = 2, width = 45,
                                             font = f3, bg = '#f9f7f1')
